...
public class CommandeController implements Serializable {
   ...
   private Commande indeice;

    public CommandeController() {
    }

    public Commande getIndeice() {
        return indeice;
    }

    public void setIndeice(Commande indeice) {
...
//recherche
       public void Search()
{if(ejbFacade.search(magasin,fournisseur,datemin,datemax)!=null)
    items=ejbFacade.search(magasin,fournisseur,datemin,datemax);
}
//       public Commande findlastcommande()
//       {
//           return ejbFacade.findlastcommande();
//       }
//       
